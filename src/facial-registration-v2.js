...
async function main() {
  ...
  try {
    registration = new FacialRegistrationService();
    ...
    // Garante limpeza dos recursos
    if (
      registration &&
      registration.imageProcessor &&
      registration.imageProcessor.destroy
    ) {
      await registration.imageProcessor.destroy();
    }
  }
}
